 ...
 * @date    April 12, 2026
 * @brief   Hardware Abstraction Layer for UART (RX/TX).
 * @details Implements non-blocking interrupt-driven reception via Ring Buffer 
 * and blocking transmission for reliable data streaming.
 * @version 2.1
 */
