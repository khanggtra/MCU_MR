 ...
 * @date    April 11, 2026
 * @brief   System Tick Manager.
 * @details Provides an absolute time reference (uptime in milliseconds) 
 * for task scheduling and non-blocking delays. This module is hardware-independent 
 * at the application layer, relying on the underlying HAL timer.
 * @version 1.1
 */
