 ...
 * @date    April 12, 2026
 * @brief   Lightweight string formatting utilities.
 * @details Replaces the heavy <stdio.h> sprintf() for converting numbers 
 * to strings. Optimized for 8-bit microcontrollers to save RAM and Stack depth.
 * @version 1.0
 */
